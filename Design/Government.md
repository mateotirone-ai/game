...
**Full systems** (see `Design/Decisions/20260810_justice-crime.md`): crimes, enforcement, courts/trials. Minor via offices; **serious via jury/vote**. Sentences are **fines / restitution only** — no player jail. Complements war-flag.
